...
# Specify the input data and three empty lists: one for the input differential bit weight, one for 
# the output differential bit weight and one for the number of differences.

input_file = '../data/skinny128-differential-hamming-weight-2D.txt'
input_weight = []
output_weight = []
count = []
...
ax.set_xlabel('Input Differential Bit Weight')
ax.invert_xaxis()
ax.set_ylabel('Output Differential Bit Weight')
...
# Set the title of the plot and save this to the file 2D-differential-bit-weight-skinny128.png

plt.title('Skinny128')
plt.savefig('results/2D-differential-bit-weight-skinny128.png', bbox_inches='tight')
