...
input_file = '../data/skinny64-differential-hamming-weight-2D.txt'
input_weight = []
output_weight = []
count = []
...
# Set the title of the plot and save this to the file 2D-differential-bit-weight-skinny64.png

plt.title('Skinny64')
plt.savefig('results/2D-differential-bit-weight-skinny64.png', bbox_inches='tight')
