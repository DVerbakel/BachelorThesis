...
input_file = '../data/skinny128-linear-hamming-weight-2D.txt'
input_weight = []
output_weight = []
count = []
...
# Set the title of the plot and save this to the file 2D-linear-bit-weight-skinny128.png

plt.title('Skinny128')
plt.savefig('results/2D-linear-bit-weight-skinny128.png', bbox_inches='tight')
