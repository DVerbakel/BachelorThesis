...
# Specify the input data and three empty lists: one for the input linear box weight, one for 
# the output linear box weight and one for the number of masks.

input_file = '../data/skinny128-linear-box-superbox-2D.txt'
input_weight = []
output_weight = []
count = []
...
ax.set_xlabel('Input Linear Box Weight')
ax.invert_xaxis()
ax.set_ylabel('Output Linear Box Weight')
...
# Set the title of the plot and save this to the file 2D-linear-box-weight-skinny128.png

plt.title('Skinny128')
plt.savefig('results/2D-linear-box-weight-skinny128.png', bbox_inches='tight')
