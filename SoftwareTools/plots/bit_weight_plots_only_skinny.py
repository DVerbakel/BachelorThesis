...
triples = [('../data/skinny64-artificial-skinny384-differential-hamming-weight-full.txt', '<-', '#32CD32', 'Skinny64-384-dif'),
...
# Set the legend and grid of the plot and save this to the file bit_weights_only_skinny.pdf

plt.legend(fontsize = 'small')
plt.grid(b=True, which='major')
plt.savefig('results/bit_weights_only_skinny.pdf', bbox_inches='tight')
