...
triples = [('../data/skinny64-differential-hamming-weight.txt', '<-', '#32CD32', 'Skinny64-dif'),
...
# Set the legend and grid of the plot and save this to the file bit_weights_superbox_only_skinny.pdf

plt.legend(loc='upper left', fontsize = 'small')
plt.grid(b=True, which='major')
plt.savefig('results/bit_weights_superbox_only_skinny.pdf', bbox_inches='tight')
