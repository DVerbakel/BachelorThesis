...
triples = [('../data/aes-box-full.txt', 'D-', 'r', 'Rijndael'),
           ('../data/saturnin-box-full.txt', 's-', 'b', 'Saturnin'),
           ('../data/skinny64-artificial-skinny384-differential-box-full.txt', '<-', '#32CD32', 'Skinny64-384-dif'),
...
# Set the legend and grid of the plot and save this to the file box_weights_comparison.pdf

plt.legend()
plt.grid(b=True, which='major')
plt.savefig('results/box_weights_comparison.pdf', bbox_inches='tight')
