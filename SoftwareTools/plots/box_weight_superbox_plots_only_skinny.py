...
triples = [('../data/skinny64-differential-box-superbox.txt', '<-', '#32CD32', 'Skinny64-dif'),
...
# Set the legend and grid of the plot and save this to the file box_weights_superbox_only_skinny.pdf

plt.legend()
plt.grid(b=True, which='major')
plt.savefig('results/box_weights_superbox_only_skinny.pdf', bbox_inches='tight')
