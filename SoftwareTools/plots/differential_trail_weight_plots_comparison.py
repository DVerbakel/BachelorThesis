...
# Set the legend and grid of the plot and save this to the file differential_trail_weights_comparison.pdf

plt.legend(fontsize = 'small')
plt.grid(b=True, which='major')
plt.savefig('results/differential_trail_weights_comparison.pdf', bbox_inches='tight')
