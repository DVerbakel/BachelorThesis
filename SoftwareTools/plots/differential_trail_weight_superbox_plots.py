...
triples = [('../data/aes-differential-trail-superbox.txt', 'D-', 'r', 'Rijndael'),
           ('../data/saturnin-differential-trail-superbox.txt', 's-', 'b', 'Saturnin'),
           ('../data/skinny64-differential-trail-superbox.txt', '<-', '#32CD32', 'Skinny64'),
           ('../data/spongent-differential-trail-superbox.txt', 'X-', 'y',  'Spongent')]
...
# differential trail weights and then plot the cumulative differential trail weight histograms of the superboxes.
...
plt.xlim(0, 50)
plt.ylim(0, 140)
plt.xlabel('Differential Trail Weight Superbox', fontsize=16)
plt.ylabel('Log2(Number of Trails)', fontsize=16)

# Set the legend and grid of the plot and save this to the file differential_trail_weights_superbox.pdf

plt.legend(fontsize = 'small')
plt.grid(b=True, which='major')
plt.savefig('results/differential_trail_weights_superbox.pdf', bbox_inches='tight')
