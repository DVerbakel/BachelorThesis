...
triples = [('../data/aes-linear-trail-full.txt', 'D-', 'r', 'Rijndael'),
           ('../data/saturnin-linear-trail-full.txt', 's-', 'b', 'Saturnin'),
...
# Set the legend and grid of the plot and save this to the file linear_trail_weights.pdf

plt.legend(fontsize = 'small')
plt.grid(b=True, which='major')
plt.savefig('results/linear_trail_weights.pdf', bbox_inches='tight')
