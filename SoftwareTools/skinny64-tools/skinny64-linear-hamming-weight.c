...
main(void)
{
	...
	*/
	 ...
	 * we save the results to the file skinny64-linear-hamming-weight.txt.
	*/
	...
	table_print("data/skinny64-linear-hamming-weight.txt", hamming_weights);
	
	/*
	 * Convolute the above results of one column in order to compute the histogram of the full state(s). We initialize the
	 * table structure and save the results to the files skinny64-linear-hamming-weight-full.txt,
	 * skinny64-artificial-skinny256-linear-hamming-weight-full.txt and 
	...
	*/
	...
	// Data: (hamming weight, not used, number of masks)
	table_print("data/skinny64-linear-hamming-weight-full.txt", hamming_weights_full);
	table_print("data/skinny64-artificial-skinny256-linear-hamming-weight-full.txt", hamming_weights_full_256);
	table_print("data/skinny64-artificial-skinny384-linear-hamming-weight-full.txt", hamming_weights_full_384);
